...
from reproducible_ephys_functions import filter_recordings, BRAIN_REGIONS, save_figure_path
...
fig_path = save_figure_path(figure='figure7')
...
for reg in BRAIN_REGIONS:
    ...
    plt.savefig(fig_path.joinpath(f'figure7SuppFF_Spatial_{reg}.png'))
