...
def label_with_letter(ax, L):
    ax.text(-0.3, -0.2, L, transform=ax.transAxes, 
            size=16, weight='bold')
...
for region in ["Isocortex", "TH", "HPF"]:
    ...
    sns.pointplot(x="source", y="num_sites", data=passing_per_site_ste, ax=axes[0, 1], join=False, markersize=2, marker="none", capsize=.2, errorbar=("se", 1), color="black", err_kws=err_kws, zorder=100)
    sns.pointplot(x="source", y="num_sites", data=passing_per_site_ibl, ax=axes[0, 1], join=False, markersize=2, marker="none", capsize=.2, errorbar=("se", 1), color="black", err_kws=err_kws, zorder=100)
    sns.pointplot(x="source", y="num_sites", data=passing_per_site_aln, ax=axes[0, 1], join=False, markersize=2, marker="none", capsize=.2, errorbar=("se", 1), color="black", err_kws=err_kws, zorder=100)
    ...
    #axes[0, 1].set_ylabel("Sites in region per insertion")
    ...
    sns.pointplot(x="source", y="all_units", data=passing_per_site_ste, ax=axes[0, 2], join=False, markersize=2, marker="none", capsize=.2, errorbar=("se", 1), color="black", err_kws=err_kws, zorder=100)
    sns.pointplot(x="source", y="all_units", data=passing_per_site_ibl, ax=axes[0, 2], join=False, markersize=2, marker="none", capsize=.2, errorbar=("se", 1), color="black", err_kws=err_kws, zorder=100)
    sns.pointplot(x="source", y="all_units", data=passing_per_site_aln, ax=axes[0, 2], join=False, markersize=2, marker="none", capsize=.2, errorbar=("se", 1), color="black", err_kws=err_kws, zorder=100)
    ...
    #axes[0, 2].set_ylabel("Units in region per insertion", fontsize=8)
    ...
    #axes[0, 3].set_ylabel("Units per site in region", fontsize=8)
