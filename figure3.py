...
ax = {'panel_A': fg.place_axes_on_grid(fig, xspan=[0.05, 0.6], yspan=[0.05, 0.45],
                                       dim=[1, n_columns], wspace=0.3),
      'panel_B': fg.place_axes_on_grid(fig, xspan=[0.05, 0.6], yspan=[0.6, 1],
                                       dim=[1, n_columns], wspace=0.3),
      'panel_C': fg.place_axes_on_grid(fig, xspan=[0.82, 1], yspan=[0.05, 0.38]),
