...
%'/Users/mt/Downloads/FlatIron/paper_repro_ephys_data/fig_taskmodulation/'; %figure7/';
...
CSVfile = [data_path, 'figure7_dataframe_filt.csv'];%'fig_taskmodulation_dataframe.csv'];%'figure7_dataframe.csv']; %'figure7_dataframe.csv'];
