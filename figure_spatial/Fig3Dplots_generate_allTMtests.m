function [] = Fig3Dplots_generate_allTMtests(CSVfile, BrainRegion, save_path)
...
TM_test5 = 'trial'; %'post_reward';%
TM_test6 = 'post_move'; %
TM_test7 = 'post_reward';%
...
figure(f)
ax(7) = subplot(4,2,7);
[~, pMWU_corrTM7] = plot3D_TM(CSVfile,...
    BrainRegion, TM_test7, [0,0,0], ax(7), save_path);
...
disp([pMWU_corrTM1; pMWU_corrTM2; pMWU_corrTM3; pMWU_corrTM4;...
    pMWU_corrTM5; pMWU_corrTM6; pMWU_corrTM7])

disp({'x','y','z','amp','p2t dur'})
disp([pMWU_corrTM1; pMWU_corrTM2; pMWU_corrTM3; pMWU_corrTM4;...
    pMWU_corrTM5; pMWU_corrTM6; pMWU_corrTM7]<0.05)
