...
from figure_spatial.figure_satial_prepare_data import prepare_data, default_params
from figure_spatial.figure_spatial_plot_data import plot_supp_figure
from reproducible_ephys_functions import get_insertions
from one.api import ONE


def run_figure_spatial(one, recompute=False):
...
if __name__ == '__main__':
    one = ONE()
    run_figure_spatial(one, recompute=True)
