...
elseif strcmp(BrainRegion, 'LP')
    rot = -45; pos1 = [-690 -220 -588]; pos2=[-667 -380 -600]; pos3=[-650 -338 -609];%pos1 = [-642 -343 -612];
...
%choose function plot3D_FR or plot3D_FR_SpecLab
...
xlabel('\Delta FR (early movement - pre-stim)')%('\Delta FR (TW pre-movement - pre-stim)')
...
disp('Control: Linear Regression Model of Firing Rate SHUFFLE')
...
disp('Linear Regression Model of Firing Rate')
