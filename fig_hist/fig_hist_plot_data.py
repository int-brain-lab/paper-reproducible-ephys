...
from fig_hist.figure_hist_plot_channels_all_subjs import plot_channels_n3
...
def plot_hist_figure(raw_histology=False, perform_permutation_test=False):
    ...
    panel_B = fig_path.joinpath('B_channels_subj3_hist_coronal.svg') if raw_histology else \
        repo_path().joinpath('fig_hist', 'fig_hist_schematics', 'B_channels_subj3_hist_coronal.svg')
