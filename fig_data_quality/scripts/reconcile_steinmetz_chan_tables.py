...
clusters = pd.read_parquet(tables_dir.joinpath("clusters_steinmetz.pqt"))
channels = pd.read_parquet(tables_dir.joinpath("channels_steinmetz.pqt"))
channels_rms = pd.read_parquet(tables_dir.joinpath("channels_steinmetz_noiserms.pqt"))
channels_w = pd.read_parquet(tables_dir.joinpath("channels_steinmetz_WM.pqt"))
...
channels.to_parquet(tables_dir.joinpath("channels_steinmetz.pqt"))