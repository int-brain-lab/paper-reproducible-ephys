...
clusters = pd.read_parquet(tables_dir.joinpath("clusters_RE.pqt"))
channels = pd.read_parquet(tables_dir.joinpath("channels_RE.pqt"))
channels_rms = pd.read_parquet(tables_dir.joinpath("channels_RE_noiserms.pqt"))
channels_w = pd.read_parquet(tables_dir.joinpath("channels_RE_WM.pqt"))
...
channels.to_parquet(tables_dir.joinpath("channels_RE.pqt"))