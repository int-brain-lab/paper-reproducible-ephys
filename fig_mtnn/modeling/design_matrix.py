...
class DesignMatrix:
    ...
    def __init__(self, trialsdf, vartypes, duration=None, binwidth=0.05):
        """
        ...
        for i, (start, end) in trbounds.iterrows():
            ...
            trialsdf.at[i, 'duration'] = end - start if duration is None else duration
    ...
    def add_covariate(self, covlabel, regressor, bases,
        ...
        for i in self.trialsdf.index:
            ...
            #print(i, regressor.loc[i].shape[0], nT)
