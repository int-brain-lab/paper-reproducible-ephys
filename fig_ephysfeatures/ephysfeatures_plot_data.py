...
import pickle
from reproducible_ephys_functions import figure_style, filter_recordings, save_figure_path, labs, get_row_coord, get_label_pos
from one.api import ONE
import numpy as np


def plot_main_figure_test(freeze=None):
    # Settings
    ...
    adjust = 0.3
    fig.subplots_adjust(top=1-adjust/height, bottom=(adjust + 0.3)/height, left=(adjust + 0.2)/width, right=1-(adjust + 0.2)/width)
    plt.savefig(save_path.joinpath('figure3_test.png'))
    plt.savefig(save_path.joinpath('figure3_test.pdf'))
    plt.savefig(save_path.joinpath('figure3_test.svg'))
...
if __name__ == '__main__':
    ...
    p_decoding, p_permut = plot_main_figure_test(freeze='freeze_2024_03')
