...
def run_fig_ephysfeatures(one, recompute=False, supplementary=True, freeze='release_2023_12'):
...
if __name__ == '__main__':
    ...
    # Create figure
    run_fig_ephysfeatures(one=one, recompute=False, supplementary=True, freeze='release_2023_12')
