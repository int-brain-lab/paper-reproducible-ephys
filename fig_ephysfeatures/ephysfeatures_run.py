...
def run_fig_ephysfeatures(one, recompute=False, supplementary=True, freeze='release_2022_11'):
...
if __name__ == '__main__':
    ...
    # Create figure
    run_fig_ephysfeatures(one=one, recompute=False, supplementary=True, freeze='release_2022_11')
